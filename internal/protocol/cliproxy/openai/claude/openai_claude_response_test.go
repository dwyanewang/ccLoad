...
func TestStreamingUsage_PreservesCacheWriteTokens(t *testing.T) {
	tests := []struct {
		...
		{
			name:            "ccLoad cached_creation_tokens alias",
			usageJSON:       `{"prompt_tokens":1000,"completion_tokens":200,"prompt_tokens_details":{"cached_tokens":800,"cached_creation_tokens":150}}`,
			wantInputTokens: 50, wantOutputTokens: 200, wantCacheReadTokens: 800, wantCacheWriteTokens: 150,
		},
		{
			name:            "top-level cache creation wins over aliases",
			usageJSON:       `{"prompt_tokens":1000,"completion_tokens":200,"cache_creation_input_tokens":150,"prompt_tokens_details":{"cached_tokens":800,"cache_write_tokens":100}}`,
			wantInputTokens: 50, wantOutputTokens: 200, wantCacheReadTokens: 800, wantCacheWriteTokens: 150,
		},
		{
