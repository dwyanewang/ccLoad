...
const (
	// MaxGeminiThoughtSignatureLen caps opaque Gemini thought signatures.
	MaxGeminiThoughtSignatureLen = 32 * 1024 * 1024

	// GeminiSkipThoughtSignatureValidator is Gemini's synthetic-history bypass sentinel.
	GeminiSkipThoughtSignatureValidator = "skip_thought_signature_validator"
	// GeminiContextEngineeringBypass is an alternate Gemini bypass sentinel.
...
// GeminiThoughtSignatureEnvelope identifies a recognized transport envelope.
type GeminiThoughtSignatureEnvelope string

const (
	// GeminiThoughtSignatureEnvelopeUnknown marks an unrecognized envelope.
	...
	// GeminiThoughtSignatureEnvelopeASCIIUUID marks a UUID-shaped payload.
