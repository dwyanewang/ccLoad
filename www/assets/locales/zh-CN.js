...
window.I18N_LOCALES['zh-CN'] = Object.assign(window.I18N_LOCALES['zh-CN'] || {}, {
  ...
  'www.home.features.cost.desc': '自定义模型价格、单 Key 倍率、渠道每日限额与令牌总/日/月限额；OAuth 额度窗口对齐上游重置时间。',
  'www.home.features.oauth.title': 'OAuth 渠道',
  'www.home.features.oauth.desc': '接入 Codex、Anthropic、Antigravity、xAI、CodeBuddy、Z.ai Coding Plan、Cursor 与 Zed 账号，在渠道列表刷新额度和余额。',
  ...
  'www.home.oauth.codebuddy.title': 'CodeBuddy',
  'www.home.oauth.codebuddy.desc': '扫码登录或导入 workbuddy.json 凭证，获取账号模型、自动刷新令牌，并在渠道卡片刷新余额；国内版还支持每日签到。',
  ...
  'www.home.oauth.zed.desc': '原生应用登录：临时 RSA 密钥对换取加密回调凭证，解密为长期凭证。试用权限绑定真实 Zed 安装的 system_id；固定 /completions 上游走 Codex 协议 + local 转换。',
